...
public class LoginView extends JPanel
{
	...
	{ 
		...
		inputId.setFont(new Font("맑은 고딕" , Font.PLAIN , 30));
		...
		inputPassword.setFont(new Font("맑은 고딕" , Font.PLAIN , 30));
		inputPassword.setForeground(Color.GRAY);
		inputPassword.setText("비밀번호");
		inputPassword.addFocusListener(new FocusListener() 	//placeHolder 효과
		{
			boolean first = true;
			public void focusGained(FocusEvent e) {
				if(first)
		...
		btnLogin.setFont(new Font("맑은 고딕" , Font.PLAIN , 30));
		...
		btnSignUp.setFont(new Font("맑은 고딕" , Font.PLAIN , 30));
